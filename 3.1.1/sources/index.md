...
In addition to OpenID Connect, oxd also implement the UMA 2.0 profile of OAuth 2.0, which enables claims-based authorization and multi-step consent, user-interactions and stepped-up authentication flows. 
