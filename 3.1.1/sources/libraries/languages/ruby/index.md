...
The following documentation demonstrates how to use oxd's Ruby library to send users from a Ruby application to an OpenID Connect Provider (OP), like the [Gluu Server](https://gluu.org/gluu-server) or Google, for login. 
