...
Using oxd, web apps can securely send users to your Gluu Server OpenID Connect Provider (OP) and UMA Authorization Server (AS) for dynamic enrollment, single sign-on (SSO), and access management policy enforcement. 
