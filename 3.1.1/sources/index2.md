...
Using oxd, you can securely send users from web apps to your Gluu Server for dynamic enrollment, single sign-on (SSO), and access management policy enforcement. 
