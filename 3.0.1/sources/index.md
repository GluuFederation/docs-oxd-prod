...
!!! Note
    If you need to integrate other types of apps with your Gluu Server, like single-page apps or native apps, review the [SSO integration guide](https://gluu.org/docs/ce/integration/) in the Gluu Server documentation.
