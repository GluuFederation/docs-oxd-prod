...
## Introduction
oxd exposes simple, static APIs to facilitate user authentication and authorization against external OAuth 2.0 identity providers (IDP) like the [Gluu Server](https://gluu.org/docs/ce).
