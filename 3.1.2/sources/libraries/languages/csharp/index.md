...
- *Install from NuGet* - Use the NuGet Package Manager Console of Visual Studio
...
- *Source from Github* -   [Download](https://github.com/GluuFederation/oxd-csharp/archive/3.1.2.zip) the zip of the oxd CSharp library.
