...
- _Source from Github_ -   [Download](https://github.com/GluuFederation/oxd-csharp/archive/3.1.4.zip) the zip of the oxd CSharp library

### Important Links

- [oxd docs](https://gluu.org/docs/oxd)
- oxd-Csharp [API docs](https://rawgit.com/GluuFederation/oxd-csharp/3.1.4/docs/html/index.html) for the auto-generated Csharp docs, which includes more in-depth information about the various functions and parameters
- See the code of a [sample .Net app](https://github.com/GluuFederation/oxd-csharp/tree/3.1.4/GluuDemoWebsite) built using oxd-sharp
...
Below are minimal configuration examples for sockets and HTTPS transport. The [oxd_config.json](https://github.com/GluuFederation/oxd-csharp/blob/3.1.4/GluuDemoWebsite/oxd_config.json) file contains a full list of configuration parameters and sample values. 
