...
## Pricing & Billing
- Pricing is based on the number of OAuth 2.0 clients that are created by your oxd server in the corresponding Authorization Server (AS).  
 
- The first 10 clients generated by your oxd server are free, forever.    

- Additional clients created using oxd are billed $10 per month. Only clients active for five (5) consecutive days or more are elligible for billing. For example, if you have already used your 10 free clients, and an 11th client is created and actively used for more than five (5) consecutive days in the month, your bill for the month would be USD $10.
...
oxd is commercially licensed software. See the above [pricing and billing section](#pricing--billing) for more details. 
