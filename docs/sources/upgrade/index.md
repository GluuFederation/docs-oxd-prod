...
Before moving forward with an upgrade to oxd 4.3, review the following legacy compatibility notes:

- UMA 2.0: Supported in oxd 4.3 (since 3.1.4) and Gluu Server 4.3 (since 3.1.4)
- UMA 1.0.1: **Not** supported in oxd 4.3 (since 3.1.4) or Gluu Server 4.3 (since 3.1.4)
