...
1. download oxd distribution zip: https://ox.gluu.org/maven/org/gluu/oxd-server/4.1.1.Final/oxd-server-4.1.1.Final-distribution.zip

1. create a new directory ($OXD_SERVER_HOME) with appropriate name and unzip the downloaded `oxd-server-4.1.1.Final-distribution.zip` into it.
