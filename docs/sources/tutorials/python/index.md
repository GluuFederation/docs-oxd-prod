...
- Follow [these instructions](https://gluu.org/docs/ce/4.0/installation-guide/install/) to install Gluu Server 4.0. In this tutorial, I installed Gluu Server on host **op.server.com**.
