...
oxd 4.2 includes architectural changes as well as different bug fixes and improvements:
 ...
 - Included validations and improvements in oxd apis (Example: generate `client-jwks` and [request_uri](https://openid.net/specs/openid-connect-core-1_0.html#RequestUriParameter))
