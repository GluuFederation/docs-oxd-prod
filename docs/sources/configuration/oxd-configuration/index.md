...
- **op_configuration_endpoint:** The openid configuration endpoint URL. (Example: "op_configuration_endpoint": "`https://op.example.com/acme/.well-known/openid-configuration`")
